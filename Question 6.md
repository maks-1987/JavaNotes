...
элементов, то элементы, следующие за последним из коллекции, устанавливаются равными null. Если любой элемент коллекции имеет тип, не являющийся подтипом массива array, передается исключение ArrayStoreException
